...
void main(void)
  {
    ...
    vec3 ambient_term= ambient_light * ex_Color; // ambient_material=objectColor
    ...
    vec3 diffuse_term = diff * diffuse_light * ex_Color; // diffuse_material=objectColor
    ...
    vec3 specular_term = spec * specular_light * ex_Color;   // specular_material=objectColor
