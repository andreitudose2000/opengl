...
// sursa de lumina
float xL = 100.f, yL = 300.f, zL = 400.f;
...
void CreateShadersVertex(void)
{
	...
	ProgramIdv = LoadShaders("11_sfera_umbra.vert", "11_01f_Shader.frag");
	glUseProgram(ProgramIdv);
}
void CreateShadersFragment(void)
{
	ProgramId = LoadShaders("11_sfera_umbra.vert", "11_01f_Shader.frag");
